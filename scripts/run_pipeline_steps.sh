...
BASEDIR="C:\Users\phamq\OneDrive\Desktop\school stuff\691\A04\RAG_project\code"
...
# ----------------------------------
# python "$BASEDIR/main.py" step04_retrieve_chunks --query_args "regional development in japan"
